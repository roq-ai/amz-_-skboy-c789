...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`AMZ._.skboy`}</title>

        <meta
          name="description"
          content="Experience seamless shopping with AMZ._.skboy, your ultimate destination for a convenient and enjoyable online shopping journey."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1483985988355-763728e1935b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzaG9wcGluZ3xlbnwwfHx8fDE2OTAwMzg4ODB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@freestocks?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`freestocks`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless shopping with AMZ._.skboy, your ultimate destination for a convenient and enjoyable online shopping journey.`}
            </Text>
            <Box
